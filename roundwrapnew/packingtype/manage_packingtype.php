                ...
                <table class="table table-bordered data-table">
                    ...
                    <tbody>
                        ...
                        foreach ($listofpackingtype as $key => $value) {
                            ?>
                            <tr class="gradeX">
                                <td><a href="index.php?pagename=edit_packingtype&id=('<?php echo $value["id"] ?>')" class="tip-top" data-original-title="Edit Record"><i  class="icon-edit"></i></a></td>
    ...
    <div class="modal-body">
        <form class="form-horizontal" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
            <div class="control-group">
                ...
                <div class="controls"><input type="text"  class="custominput" name="type" id="type"></div>
