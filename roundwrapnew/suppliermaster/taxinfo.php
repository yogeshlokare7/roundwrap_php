<hr/>
<center>
                <table class="table" id="taxInfo" style="width: 60%;">
                    <thead>
                        <tr>
                    ...
                    <tr>
                        <td style="width: 2.3%"><input type="checkbox" class="checker" name="tax_check[]"></td>
  ...
  <script type="text/javascript">
    jQuery(function () {
        ...
        jQuery('a.icon-plus').click(function (event) {
            ...
            var newRow = jQuery('<tr><td style="width: 2.3%"><input type="checkbox" class="checker" name="tax_check[]"></span></td>' +
