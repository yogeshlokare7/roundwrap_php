                ...
                <tr>
                    <td>
                        <fieldset  class="well the-fieldset">
                            <table border="0">
                                <tr>
                                    <td style="width: 20%"><label class="control-label"   class="control-label">CUSTOMER NAME&nbsp;:&nbsp</label>
                                        <input  type="text" placeholder="" value="<?php echo $customer["cust_companyname"] ?>" readonly=""/></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td ><label  class="control-label"  class="control-label">BILLING&nbsp;ADDRESS&nbsp;:&nbsp</label>
                                        <textarea style="line-height: 18px;"readonly=""><?php echo $customer["billTo_address"] ?></textarea></td>
                                    <td style="width: 22%"><label class="control-label" readonly="">SHIPPING&nbsp;ADDRESS&nbsp;:&nbsp</label>
                                        <textarea style="line-height: 18px;" readonly=""><?php echo $customer["shipping_address"] ?></textarea></td>
