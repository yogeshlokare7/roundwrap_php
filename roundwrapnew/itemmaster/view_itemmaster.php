...
$vendorname = MysqlConnection::fetchCustom("SELECT  companyname FROM `supplier_master` WHERE supp_id =  " . $item["vendorid"]);
?>
<style>
    tbody {
        height: auto;
...
<div class="container-fluid"  >
    ...
    <fieldset class="well the-fieldset">
                        ...
                        <fieldset class="well the-fieldset">
                            <table  style="vertical-align: top" border="0">
                                ...
                                <tr style="vertical-align: top">
                                    ...
                                    <td >Currency<br/><input type="text"  value="<?php echo getcurrency($item["currency"]) . " (" . $item["currency"] . ")" ?>" readonly=""/></td>
                                    <td >Preferred Vendor<br/><input type="text" value="<?php echo $vendorname[0]["companyname"] ?>" readonly=""/></td>
                                </tr>
                            </table> 
                        </fieldset>
                    </td>
        ...
        <div style="float: right;width: 20%">
            <div>
                <img src="<?php echo $item["itempic"]?>" style="width: 100%;height: 100%;"/>
            </div>
        </div>
    </fieldset>
